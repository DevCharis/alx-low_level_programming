 ...
 * @argc: Argument count
 * @argv: Argument vector containing the filename of the ELF file
 *
 * Description: This program reads an ELF file, verifies it's a valid ELF file,
 * and then displays the ELF header information. If the file is not an ELF file
 * or any error occurs during reading,the program exits with status code 98 and
